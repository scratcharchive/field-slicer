...
def generate_miniwasp_fields():
    ...
    geom_fname = kp.load_file('sha1://fce1fb4c8637a36edb34669e1ac612700ce7151e/lens_r01.go3')

    n_components = 1

    # compute number of patches and points (for estimating the amount of memory needed)
    ...
    print('------- H', H_ex.dtype, H_ex[0, 0:5])
    print('------- E', E_ex.dtype, E_ex[0, 0:5])
